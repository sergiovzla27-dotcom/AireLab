...
Datos de calidad del aire en Navojoa desde OpenWeather API
"""
...
def obtener_datos_actuales():
    """Obtiene datos actuales de calidad del aire desde OpenWeather"""
    ...
    try:
        ...
        if respuesta.status_code == 200:
            ...
            pm25 = round(contaminantes['pm2_5'], 2)
            ...
            return {
                ...
                "aqi": aqi,
                "nivel": interpretar_pm25(pm25),
                "recomendaciones": obtener_recomendaciones(pm25)
            }
        else:
